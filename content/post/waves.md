...
6.  [三角形](#orgd6088b0)
    ...
    2.  [三角形指引](#org734df93)
        1.  [原文](#org5fb15f9)
7.  [双重和三重锯齿形](#org966f5aa)
    1.  [双重和三重锯齿形规则](#orgbce8920)
        1.  [原文](#org7e7f632)
    2.  [双重和三重锯齿形指引](#org1a70181)
        1.  [原文](#org7b43123)
8.  [双重和三重横向调整形--](#org2b352e0)
    1.  [双重和三重横向调整形规则](#org0b9c573)
        1.  [原文](#org77ed3eb)
    2.  [双重和三重横向调整形指引](#org6d6d004)
        1.  [原文](#org0230525)
...
> 本，但是总感觉翻译得不好，又或者自己的理解能力有限，所以自己从头到尾翻  
...
> ****价格运行总量(The gross price movement)**** ：与“正统的头和底”相对应，有时，一个形态的起点-终点与它的内部价格运行的端点不一致。例如：2浪的B子浪高于A子浪的起点。  
> 
> ****楔（xié）形(Diagonal Triangle)**** ：有的中文书翻译成“倾斜三角形”，但由于本文的规则和指引较多，为不引起与调整性质的“三角形”造成误会，本文使用“楔形”的说法。  
> 
> ****价格（Price）**** ：起点到终点的直线距离，即“正统的头和底”。  
> 
...
> 
> ****调整浪**** ：三角形、锯齿形、平台型、双重锯齿形、三重锯齿形、三重横向调整、联合型归  类为调整浪型，是在主要运动方向上的中继，不会改变原来的运动方向。  
> 
> ****非调整浪**** ：这个是我自己的归类，把推动浪和楔形归入到此类，便于理解。  
...
> -   浪4在杠杆市场有时可能会与浪2在价格上有最高可达15%的重叠。
...
> 原文中楔形的版面在平台型和三角形之间，楔形和推动浪为非调整浪，所以为了分类方便，放在此处。如果有不理解的浪型类别，可以先学习三角形、平台形和锯齿形族类调整浪的内容。  
...
> 楔形是一种常见的5浪推动形态，标示为1-2-3-4-5，随着大的趋势移动。楔形是在两个通道线内移动，从第1浪到第3浪和第2浪到第4浪，楔形必须是收敛的（此处存疑，现实中是存在扩张楔形的，原文没有提出）。  
...
> -   浪3的价格必须大于浪2。
> -   浪4可以是任何调整浪。
> -   波2和波4必须有重叠，如果不重叠，可以考虑是推动浪<sup><a id="fnr.1" class="footref" href="#fn.1">1</a></sup>，重叠长度长度在浪3的10%以内，所有内部数据点都要考虑。
...
> -   引导楔形的第1波通常是推动浪，但在极少数情况下可能是引导楔形。（可能是多方力量还不足以形成推动浪，才形成了引导楔形）
> -   浪2通常为锯齿形族类。
...
> 锯齿形是一个A-B-C的三浪结构，一般是与大的趋势背道而驰。这是最常见的三浪艾略特形态。锯齿形是调整浪。  
> 
> -   A浪必须是一个推动浪或引导楔形。
> -   B浪只能是调整浪。
...
> 平台形形态是一种三浪形态，标示为A-B-C的三浪形态，一般是侧向移动。它是调整浪和反趋势型，是一种非常常见的艾略特形态。  
> 
> -   浪A可以是任何调整浪，但三角形除外。
> -   浪B可以是任何调整浪，但三角形除外。
> -   浪B必须回调超过浪A的70%以上。
...
> -   浪C所耗费的时间一般在浪A的61.8%到浪A和浪B最短浪的161.8%之间。(原文为浪1的61.8%)
...
> 双重(DZ)和三重(TZ)锯齿形规则与锯齿形规则类似，通常是两个或三个锯齿形图案串在一起，连接浪称为X浪，属于调整性质。双重锯齿形并不常见，三重锯齿形则比较少见。锯齿形、双重锯齿形和三重锯齿形也被统称为锯齿形族类，或称为 "之字形"族类。双重锯齿形被标注为w-x-y，而三重锯齿形被标注为w-x-y-xx-z。这两种图案都包含在下面的规则和指南列表中。下面只说明了一个双重锯齿形。  
> 
> -   浪W必须是锯齿形。
> -   浪W的浪C不能是失败形态。
> -   浪X可以是除扩张三角形外的任何调整浪。
...
> -   浪Z在价格和时间上必须不超过浪XX、Y、X或W中任何一浪的5倍。
...
> -   浪X的时间通常在浪W的61.8%到161.8%之间。（原文为浪1，应该是浪W）
...
> 双倍(D3)和三倍(T3)的侧边规律类似于平手，一般是两到三个纠缠在一起的纠缠浪，称为X浪，都是纠缠的性质。双倍线不常见，三倍线则比较少见。双倍型被标注为w-x-y，而三倍型被标注为w-x-y-xx-z。这两种图案都包含在下面的规则和指南中。下面只说明了一个双倍体3。  
> 
> -   W浪W可以是除三角、双三外的任何调整形态。
> -   W的C浪不能是失败形态。
> -   X浪可以是除三角形、双倍或三倍以外的任何调整形态。
> -   X浪的最小回撤位是W浪的70%。
> -   浪X的最大价格距离为前一浪和随后的浪的150%。所有的内部数据点都要考虑。
> -   虽然浪X没有最小时间，但最大时间是浪W的10倍。
> -   浪Y可以是除双线、三线、三线或三棱形外的任何调整形态。但是，如果浪W是人字形，则浪Y不能是人字形。
> -   Y的浪Y的价格必须大于或等于浪X的价格，但如果Y的浪是三角形，则除外。
> -   Y浪的C浪不能是失败的。
> -   Y浪的价格和时间上，Y浪必须不超过X浪或W浪的5倍。
> -   Y浪没有最小时间限制。
> -   浪XX可以是除三角、双线或三线外的任何调整形态。
> -   最小的浪XX回撤位是浪Y的70%。
> -   最大的浪XX回撤位是前一浪和随后的浪的150%。所有内部数据点都要考虑。
> -   浪Z可以是任何调整形态，但双倍或三倍形态除外。但是，如果Y是人字形，则浪Z不能是人字形。
> -   按价格计算，浪Z大于或等于XX。
> -   浪Z在价格和时间上必须不超过5倍于XX浪、Y浪、X浪或W浪。
> -   不允许背靠背和双倍失败。
> -   如果Y浪的价格变动幅度大于W浪的价格变动幅度，则Z浪的最大价格变动幅度为W浪价格变动幅度的2倍。
...
> -   按价格计算，浪W中的最大浪通常小于浪W的140%。
> -   浪X通常是人字形家族形态。
> -   浪X中最大的浪按价格计算通常小于浪W。
> -   浪X按价格计算，通常是小于W的140%的浪。
> -   按价格计算，浪X通常大于浪W的95%。
> -   浪X最可能的回撤位是浪W的110%。
> -   X浪X的时间一般在W1的62%到W1的1.618之间。
> -   如果Y浪是一个三角形，那么Y浪最可能的长度约为W浪的61.8%；如果Y浪不是三角形，那么Y浪最可能的长度为W浪的100%，为W浪的161.8%，为W浪的10%以上的长度。
> -   按价格计算，Y浪中最大的浪通常不到浪W的140%。
> -   按价格计算，Y浪的最大浪通常不到浪W和浪X的两倍。
> -   Y浪在时间上一般在W浪的61.8%到161.8%之间。
> -   浪XX通常是人字形家族形态。
> -   xx浪中最大的浪通常在价格上小于y浪的浪。
> -   按价格计算，XX浪通常小于Y浪的140%。
> -   浪XX的价格通常大于Y浪的95%。
> -   浪XX最可能的回撤位是浪Y的110%。
> -   如果浪Y是三角形，按价格计算，最可能的长度是浪W的61.8%，如果浪Y不是三角形，那么最可能的长度是浪W的100%，浪W的161.8%，浪W结束后的长度是浪W的10%，都是按价格计算。
> -   按价格计算，浪Z的最大浪通常不到浪Y的140%。
> -   按价格计算，浪Z的长度通常小于浪Y和浪XX的2倍。
...
<sup><a id="fn.1" href="#fnr.1">1</a></sup> :原文无推动浪的阐述；
